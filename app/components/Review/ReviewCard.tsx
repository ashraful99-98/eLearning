...
const ReviewCard = (props: Props) => {
    return (
    <div className='w-full h-max pb-4 dark:bg-slate-500 dark:bg-opacity-[0.20] border border-[#00000028] dark:border-[#111111fd] backdrop-blur dark:shadow-[bg-slate-700] rounded-lg p-3 shadow-inner'>
