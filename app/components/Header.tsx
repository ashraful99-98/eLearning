...
const Header:FC<Props> = ({activeItem,setOpen, route, open, setRoute}) =>{
  ...
  return (
    <div className='w-full relative'>
      ...
      <div className={`${active ? "dark:bg-opacity-50 dark:bg-gradient-to-b dark:from-gray-900 dark:to-black fixed top-0 left-0 w-full h-[80px] z-[80] transition duration-500":"w-full dark:bg-opacity-50 transition duration fixed z-[80]"
      }`}
      >
